        ...
        foreach ($users as $user) {
            ...
            if ($totalUsed < 5) {
                ...
                if ($credit->credits > 0) {
                    ...
                    // Or strictly deduct 5 days worth from entitlement?
                    // User Rule: "system deducts 5 - used from remaining VL"
                    // If remaining < daysToDeduct, we just zero it out usually.
                    ...
                    if ($deduction > 0) {
                        ...
                        ActivityLog::logAction($user->id, 'Mandatory Forfeiture', 
