    ...
    <div class="profile-container">
        ...
        <div class="profile-hero">
            ...
            <div class="profile-hero-actions">
                <button type="button" class="hero-btn hero-btn-outline" onclick="toggleSection('accountInfoSection')"
                    title="Account Info">
                    <i class="fas fa-user-circle"></i>
                </button>
                <button type="button" class="hero-btn hero-btn-primary" onclick="openModal('editProfileModal')"
                    title="Edit Profile">
                    <i class="fas fa-edit"></i>
                </button>
                <button type="button" class="hero-btn hero-btn-outline" onclick="openModal('changePasswordModal')"
                    title="Change Password">
                    <i class="fas fa-lock"></i>
                </button>
                <button type="button" class="hero-btn hero-btn-outline" onclick="toggleSection('esignatureSection')"
                    title="E-Signature">
                    <i class="fas fa-file-signature"></i>
                </button>
                @if(in_array($user->role, ['super_admin', 'admin', 'head_hr']))
                    <button type="button" class="hero-btn hero-btn-outline" onclick="toggleSection('broadcastSection')"
                                ...
                                <div class="info-value">
                                    @if($user->esignature)
                                        <img src="{{ storage_url($user->esignature) }}" alt="E-Signature"
                                            style="max-height: 50px; border: 1px solid #ddd; padding: 2px;">
                                    @else
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group full-width">
                                ...
                                <div style="display: flex; gap: 10px; margin-bottom: 15px;">
                                    <button type="button" class="btn-tab active" id="tabUpload"
                                ...
                                <div id="uploadArea">
                                    ...
                                    <small style="display: block; margin-top: 8px; color: #64748b;">
                                        Please upload a clear image of your signature (<strong>PNG only</strong> with
                        ...
                        <form action="{{ route('admin.notifications.send') }}" method="POST">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="text" class="form-control" name="message" maxlength="500"
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="custom-modal-header">
                    ...
                    <button type="button" class="custom-modal-close"
                        onclick="closeModal('editProfileModal')">&times;</button>
                </div>
