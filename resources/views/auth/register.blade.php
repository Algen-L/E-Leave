        ...
        <form id="registerForm">
            ...
            <div class="form-row">
                <div class="form-col">
                    ...
                    <input type="text" class="form-input-custom" id="first_name" name="first_name" placeholder="John" required>
                </div>
                <div class="form-col">
                    <label class="form-label-custom">Middle Name</label>
                    <input type="text" class="form-input-custom" id="middle_name" name="middle_name" placeholder="Optional">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-col">
                    ...
                    <input type="text" class="form-input-custom" id="username" name="username" placeholder="admin" required>
                </div>
                <div class="form-col">
            ...
            <label class="form-label-custom" style="margin-top: 16px;">Gmail Address</label>
            <input type="email" class="form-input-custom" id="gmail" name="gmail" placeholder="example@gmail.com" required>
