        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                @if(auth()->user()->isAdmin() || auth()->user()->isSuperAdmin() || auth()->user()->isHR() || auth()->user()->isHeadHR())
                    @php
                        $dashboardRoute = (auth()->user()->isHR() || auth()->user()->isHeadHR()) ? 'hr.dashboard' : 'admin.dashboard';
                    @endphp
                    <a href="{{ route($dashboardRoute) }}"
                        class="nav-item {{ request()->routeIs($dashboardRoute) ? 'active' : '' }}">
                        <span class="nav-icon"><i class="fas fa-home"></i></span>
                        <span class="nav-text">Dashboard</span>
                    </a>
                    <a href="{{ route('admin.manage-users') }}"
                        class="nav-item {{ request()->routeIs('admin.manage-users*') ? 'active' : '' }}">
                        <span class="nav-icon"><i class="fas fa-users"></i></span>
                        <span class="nav-text">Manage Users</span>
                    </a>
                    <a href="{{ route('admin.register-user') }}"
                        class="nav-item {{ request()->routeIs('admin.register-user') ? 'active' : '' }}">
                    ...
                    @if(auth()->user()->isSuperAdmin())
                        <a href="{{ route('admin.auth-reset-management') }}"
                            class="nav-item {{ request()->routeIs('admin.auth-reset-management') ? 'active' : '' }}">
                            <span class="nav-icon"><i class="fas fa-key"></i></span>
                            <span class="nav-text">Auth Reset</span>
                        </a>
                        <a href="{{ route('admin.signatories') }}"
                            class="nav-item {{ request()->routeIs('admin.signatories') ? 'active' : '' }}">
                    ...
                    @if(auth()->user()->isHR() || auth()->user()->isHeadHR())
                        ...
                        <a href="{{ route('hr-staff.manage-credits') }}"
                            class="nav-item {{ request()->routeIs('hr-staff.manage-credits*') ? 'active' : '' }}">
                    ...
                    @if(auth()->user()->isHeadHR() || auth()->user()->isSuperAdmin())
                        <a href="{{ route('head-hr.leave-policies') }}"
                            class="nav-item {{ request()->routeIs('head-hr.leave-policies*') ? 'active' : '' }}">
                            <span class="nav-icon"><i class="fas fa-sliders-h"></i></span>
                            <span class="nav-text">Credit Policies</span>
                        </a>
                        <a href="{{ route('head-hr.audit-logs') }}"
                            class="nav-item {{ request()->routeIs('head-hr.audit-logs*') ? 'active' : '' }}">
                    ...
                    @if(auth()->user()->isHR())
                        <a href="{{ route('user.leave.approvals') }}"
                            class="nav-item {{ request()->routeIs('user.leave.approvals') ? 'active' : '' }}">
                ...
                @else
                    ...
                    <a href="{{ route('user.leave.apply') }}"
                        class="nav-item {{ request()->routeIs('user.leave.apply') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('user.leave.history') }}"
                        class="nav-item {{ request()->routeIs('user.leave.history') ? 'active' : '' }}">
            ...
            <div class="sidebar-footer">
                <a href="{{ auth()->user()->isAdmin() || auth()->user()->isHR() ? route('admin.profile') : route('user.profile') }}"
