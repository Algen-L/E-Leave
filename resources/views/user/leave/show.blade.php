...
<style>
    ...
    .doc-check-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
    .doc-check-item { display: flex; align-items: center; gap: 8px; font-size: 0.9rem; }
    .doc-check-box { width: 16px; height: 16px; border: 1px solid #94a3b8; display: inline-flex; align-items: center; justify-content: center; }
</style>
@endpush
    ...
    <div class="flex flex-col">
        ...
        <div class="sidebar-card">
            ...
            <div class="flex flex-col gap-2">
                 <a href="{{ route('user.leave.form6', ['id' => $application->id, 'format' => 'pdf']) }}" target="_blank" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-center transition flex justify-center items-center">
                ...
                <div class="v-step {{ $s2 }}">
                    ...
                    <div class="v-step-content">
                        <div class="v-step-title">Recommendation</div>
                         <div class="v-step-desc">
                            @if($recoComplete)
                                Date Recom: {{ $application->recommended_at ? $application->recommended_at->format('M d, Y') : 'N/A' }}
                            @else
